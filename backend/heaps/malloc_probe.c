...
int main() {
  ...
  mallopt(M_CHECK_ACTION, 5);
	void *x = malloc(50);
	// skip the x
	uintptr_t afterX = (uintptr_t)x + get_true_size(x);
  ...
  written=1;
    ...
    *bufptr = (char*)buffer;
    ...
    (*bufptr)++; // opty [space]
        ...
        add_LL(x);
				nh_print_rec('0', x, get_true_size(x));
				break;
      case '1':
        ...
        add_LL(x);
        nh_print_rec('1', x, get_true_size(x));
        break;
      case '2':;
        ...
        add_LL(x);
        nh_print_rec('2', x, get_true_size(x));
        break;
      case '3': // realloc
        ...
        rm_LL((void*)ptr);
        add_LL(x);
        nh_print_rec('3', x, get_true_size(x));
        break;
      case '4':
			case 'F':
        ptr = nh_get_number(bufptr);
        if (!in_ll((void*)ptr)) {
          ...
          free((void*)ptr);
          rm_LL((void*)ptr);
  				nh_print_rec('4', (void*)ptr, get_true_size((void*)ptr));
        }
        break;
      case '5':
        // mallopt
